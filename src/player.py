...
class Player:
    ...
    def attack(self):
        self.sword.animate_rotation((-25, -25, -35), duration=0.2)
        self.sword.animate_position((2, 0, 0), duration=0.2)
        
        if (self.sword.rotation == (-25, -25, -35) and 
            self.sword.position == (2, 0, 0)):
            self.is_attacking = False
    
    def defense(self):
        self.shield.animate_rotation((-20, -20, 0), duration=0.2)
        self.shield.animate_position((-2, 0, 0), duration=0.2)
        
        if (self.shield.rotation == (-20, -20, 0) and 
